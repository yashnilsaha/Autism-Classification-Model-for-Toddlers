...
df.drop(['A7','A10','Age_Mons','Qchat-10-Score','Sex','Ethnicity','Jaundice','Family_mem_with_ASD','Case_No', 'Who completed the test'], axis = 1, inplace = True)
...
X_aut = df[["A9", "A5", "A6","A8","A1","A3","A2","A4"]]
