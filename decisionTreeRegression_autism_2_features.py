...
df.drop(['A1','A2','A3','A4','A5','A8','A7','A10','Age_Mons','Qchat-10-Score','Sex','Ethnicity','Jaundice','Family_mem_with_ASD','Case_No', 'Who completed the test'], axis = 1, inplace = True)
...
print('score for autism from my algorithm')
